...
#[derive(ProtoBuf, Default)]
pub struct IssueMuseDshDeviceTokenPB {
  #[pb(index = 1)]
  pub device_id: String,
...
#[derive(ProtoBuf, Default)]
pub struct MuseDshDeviceTokenPB {
  #[pb(index = 1)]
  pub token: String,
...
impl From<flowy_user_pub::cloud::MuseDshDeviceToken> for MuseDshDeviceTokenPB {
  fn from(value: flowy_user_pub::cloud::MuseDshDeviceToken) -> Self {
    Self {
      token: value.token,
