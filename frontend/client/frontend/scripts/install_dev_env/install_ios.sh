...
printMessage() {
    printf "${YELLOW}DSH Office : $1${ENDCOLOR}\n"
}

printSuccess() {
    printf "${GREEN}DSH Office : $1${ENDCOLOR}\n"
}

printError() {
    printf "${RED}DSH Office : $1${ENDCOLOR}\n"
}

# Install Rust
printMessage "The Rust programming language is required to compile DSH Office."
